...
//	private Value createSample(String time, String value, PCode pcode, BigDecimal aboveDatumValue) {
//		BigDecimal val = null;
//		if (null!=value) {
//			val = new BigDecimal(value);
//		}
//		return new Value(time, val, "units", val, "comment", true, pcode.getCode(), aboveDatumValue);
//	}
	/**
...
//				}
	...
	public void test_yearDiff_11yr_easy() throws Exception {
		BigDecimal yrs = yearDiff("2011-01-01", "2000-01-01");
...
//	}
	...
	public void test_daysDiff_1day() throws Exception {
		...
		BigDecimal actual = daysDiff(date2,date1);
	...
	public void test_fixMissingMonthAndDay_doNothing() throws Exception {
		...
		String actual = fixMissingMonthAndDay(expect);
...
//		List<Value> monthSamples = new ArrayList<>(2);
...
//		List<Value> monthSamples = new ArrayList<>(10);
//		monthSamples.add(createSample("2005-06-10T04:15:00-05:00", "1.0"));
//		monthSamples.add(createSample("2015-06-10T04:15:00-05:00", "2.0"));
//		monthSamples.add(createSample("2005-06-10T04:15:00-05:00", "1.0"));
//		monthSamples.add(createSample("2015-06-10T04:15:00-05:00", "2.0"));
...
//		List<Value> monthSamples = new ArrayList<>(11);
//		monthSamples.add(createSample("2005-06-10T04:15:00-05:00", "1.0"));
//		monthSamples.add(createSample("2006-06-10T04:15:00-05:00", "2.0"));
//		monthSamples.add(createSample("2007-06-10T04:15:00-05:00", "1.0"));
//		monthSamples.add(createSample("2008-06-10T04:15:00-05:00", "2.0"));
...
//	}
	...
	public void test_today__ensure_that_the_today_method_returns_the_current_month_and_year() throws Exception {
		...
		assertEquals(year, yearUTC(today) );
		...
		assertEquals(month, monthUTC(today) );
	}
	...
	public void test_month_year_extract_from_UTC() throws Exception {
		...
		year = yearUTC(dateUTC);
		assertEquals("2000", year);

		month = monthUTC(dateUTC);
		assertEquals("12", month);
	}

//	@Test
//	public void test_overallStats_0() throws Exception {
//		List<Value> samples = new ArrayList<>(0);
...
//		Value first = createSample("2005-06-10T04:15:00-05:00", "1.0");
//		List<Value> samples = new ArrayList<>(1);
//		samples.add(first);
//		Map<String,String> overall = stats.overallStats(samples, samples, MediationType.AboveDatum);
...
//		Value max = createSample("2015-06-10T04:15:00-05:00", "2.0");
//		List<Value> samples = new ArrayList<>(2);
//		samples.add(min);
//		samples.add(max);
...
//		Value min = createSample("2005-06-10T04:15:00-05:00", "1.0");
//		Value max = createSample("2015-12-10T04:15:00-05:00", "2.0");
...
//
	...
	public void test_percentileOfValue_12_75pct_90pct_SigFig_NIST() throws Exception {
		...
		BigDecimal pct23 = percentileOfValue(samples, samples.get(3), Value::valueOf);
	...
	public void test_generatePercentiles_descendingForBelowSurface() throws Exception {
		...
		samples.add( createSample("2015-12-10T04:15:00-05:00", "95.1682") );
		List<Value> sorted = new LinkedList<>(samples);
		sortByValueOrderDescending(sorted); // <--------  sorting DESCENDING instead of Ascending
		Map<String,String> percentiles = stats.generatePercentiles(sorted, PERCENTILES);
...
//			protected boolean doesThisMonthQualifyForStats(java.util.List<Value> monthSamples) {
//				return monthSamples.size()>0;
//			}
//			public List<Value> normalizeMutlipleYearlyValues(List<Value> monthSamples, MediationType mediation) {
...
//		};
//
//		mockstats.sortByValueOrderAscending(sorted);
//		Map<String, Map<String, String>> monthly = mockstats.monthlyStats(sorted, MediationType.AboveDatum);
//
...
//			@Override
//			protected MediationType findMostPrevalentMediation(Specifier spec, java.util.List<Value> samples) {
...
//	private List<Value> loadTestData(Specifier spec) {
//
...
//
//		try {
//			return Value.extractSamples(reader, agencyCd, siteNo, altVal);
//		} catch (Exception e) {
//			e.printStackTrace();
...
//	private Answer<List<Value>> loadTestData() {
//		return new Answer<List<Value>>() {
//			public List<Value> answer(InvocationOnMock invocation) {
//
...
//
//		List<Value> sortedBelowLand  = new ArrayList<>(samples1);
//		stats.sortByMediation(sortedBelowLand, MediationType.BelowLand);
//
//		List<Value> sortedAboveDatum  = new ArrayList<>(samples1);
//		stats.sortByMediation(sortedBelowLand, MediationType.AboveDatum);
//
//		List<Value> samples2  = new ArrayList<>(samples1);
//
...
//		Value explicitRetained = createSample("2015-05-11T04:15:00-05:00", "95.1567", false);
//		Value explicitRemoved  = createSample("2015-05-12T04:15:00-05:00", "95.1937", true);
//		Value recentRetained   = createSample("2015-05-13T04:15:00-05:00", "95.1959", false);
//
//		List<Value> samples1 = new LinkedList<>();
//		samples1.add( defaultRetained );  // should be retained because of default false
//		samples1.add( explicitRetained ); // should be retained because not provisional
...
//
//		Value explicitRetained = createSample("2013-05-11T04:15:00-05:00", "1.0", false);
//		Value explicitRemoved  = createSample("2014-05-12T04:15:00-05:00", "1.0", true);  // this one does not count because it is provisional
//		Value recentProvisional= createSample("2018-05-13T04:15:00-05:00", "100.0", true); // this one only counts for latest value
//
//		samples.add( explicitRetained ); // should be retained because not provisional
//		samples.add( explicitRemoved );  // should be REMOVED because provisional
...
//		Value explicitRetained = createSample("2013-05-11T04:15:00-05:00", "1.0", false);
//		Value explicitRemoved  = createSample("2014-05-12T04:15:00-05:00", "1.0", true);  // this one does not count because it is provisional
//		Value recent           = createSample("2018-05-13T04:15:00-05:00", "100.0");
//
//		samples.add( explicitRetained ); // should be retained because not provisional
//		samples.add( explicitRemoved );  // should be REMOVED because provisional
//		samples.add( recent );
...
//
//		Value a = createSample("2015-05-10T04:15:00-05:00", "95.1772");
//		Value b = createSample("2015-05-11T04:15:00-05:00", "95.1567");
//		Value c = createSample("2015-05-12T04:15:00-05:00", "95.1937");
//		Value d = createSample("2015-05-13T04:15:00-05:00", "95.1959");
//
//		List<Value> samples = new LinkedList<>();
//		samples.add( a );
//		samples.add( b );
...
//
//		List<Value> actual = stats.useMostPrevalentPCodeMediatedValue(site, samples, mediation);
//
...
//		Value a = createSample("2015-05-10T04:15:00-05:00", "95.1772", PCode.P72019, aboveDatum);
//		Value b = createSample("2015-05-11T04:15:00-05:00", "95.1567", PCode.P72019, aboveDatum);
//		Value c = createSample("2015-05-12T04:15:00-05:00", "95.1937", PCode.P72019, aboveDatum);
//		Value d = createSample("2015-05-13T04:15:00-05:00", "95.1959", PCode.P62610, aboveDatum);
//
//		List<Value> samples = new LinkedList<>();
//		samples.add( a );
//		samples.add( b );
...
//		BigDecimal aboveDatum = new BigDecimal("99.9999");
//		Value a = createSample("2015-05-10T04:15:00-05:00", "95.1772", PCode.P72019, aboveDatum);
//		Value b = createSample("2015-05-11T04:15:00-05:00", "95.1567", PCode.P62610, aboveDatum);
//		Value c = createSample("2015-05-12T04:15:00-05:00", "95.1937", PCode.P62610, aboveDatum);
//		Value d = createSample("2015-05-13T04:15:00-05:00", "95.1959", PCode.P62610, aboveDatum);
//
//		List<Value> samples = new LinkedList<>();
//		samples.add( a );
...
//		List<Value> normalizeMutlipleYearlyValues = stats.normalizeMutlipleYearlyValues(monthSamples, MediationType.BelowLand);
//
...
//		stats.sortByDateOrder(monthSamples);
//
...
//	}
	...
	// TODO move to SigFigsMathUtilTest
	@Test
