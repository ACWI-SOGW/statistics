...
public class UsgsDecimalTest {
    ...
    public void test_BigDecimal_1100() {
    	BigDecimal thousand = new UsgsDecimal("1100");
    ...
    public void test_BigDecimal_1000_0() {
    	BigDecimal thousand_5 = new UsgsDecimal("1000.0");
