...
public class SwaggerConfig {
	...
	public static final String StatsService_CALCULATE_MEDIATION="The value sort direction or the groundwater level mediation. NONE means that the data is in value order as provided. The BelowLand default matches the exmaple data.";
	public static final String StatsService_CALCULATE_MEDIANS="If true, returns the intermediate values used in the calculations. For monthly percentiles it is required that no month have more weight than any other. When a month has multiple values, the median is used. This feature returnes these intermediate values.";
